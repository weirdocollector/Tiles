...
class Spinning_Top(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        super().__init__()
        self.sprites = []
        self.sprites.append(pygame.image.load('Assets/Spin_Top_1.png').convert_alpha())
        self.sprites.append(pygame.image.load('Assets/Spin_Top_2.png').convert_alpha())
        self.sprites.append(pygame.image.load('Assets/Spin_Top_3.png').convert_alpha())
        self.sprites.append(pygame.image.load('Assets/Spin_Top_4.png').convert_alpha())
...
def main():
    ...
    spinning_top = Spinning_Top(screen_width //2, screen_height //2)
